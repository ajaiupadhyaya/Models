...
def get_routers():
    ...
    return models_router, predictions_router, backtesting_router, websocket_router, monitoring_router, paper_trading_router, investor_reports_router, company_analysis_router
...
# Include routers
try:
    models_router, predictions_router, backtesting_router, websocket_router, monitoring_router, paper_trading_router, investor_reports_router, company_analysis_router = get_routers()
    ...
    logger.info("All routers loaded successfully (including company analysis)")
except Exception as e:
