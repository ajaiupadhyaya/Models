...
def main():
    ...
    try:
        ...
        # Export to markdown
        md_path = f"data/reports/investor_report_{timestamp}.md"
        generator.export_report_to_markdown(report, md_path)
        print(f"✓ Markdown: {md_path}")
        
        # Export to HTML
        html_path = f"data/reports/investor_report_{timestamp}.html"
        ...
        print("   • See INVESTOR_REPORTS.md for API details")
